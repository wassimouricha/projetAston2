...
const $viewPresets = {
  ...
  filled: [$baseViewStyle, { backgroundColor: colors.palette.red }] as StyleProp<ViewStyle>,
...
const $pressedViewPresets: Record<Presets, StyleProp<ViewStyle>> = {
  default: { backgroundColor:  colors.palette.red},
  filled: { backgroundColor:  colors.palette.red },
  reversed: { backgroundColor:  colors.palette.red },
}
